"""
This example file fetches JSON data of Meteorite Landings 
from the web and saves it to a local file named wilcox_data/meteoritelandings.json
...
def main():
    ...
    fetch_json_file(fetched_folder_name, "meteoritelandings.json", json_url)
