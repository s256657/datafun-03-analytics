...
and saves it to a local file named titanic_original.csv in a folder named data.
...
def main():
    ...
    """
    csv_url = 'https://raw.githubusercontent.com/Geoyi/Cleaning-Titanic-Data/refs/heads/master/titanic_original.csv'
    logger.info("Starting CSV fetch demonstration...")
    fetch_csv_file(fetched_folder_name, "titanic_original.csv", csv_url)
