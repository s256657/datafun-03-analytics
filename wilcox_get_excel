...
and saves it to a local file named changesinprice.xlsx in a folder named wilcox_data.
...
def main():
    ...
    """
    excel_url = 'https://ers.usda.gov/sites/default/files/_laserfiche/DataFiles/50673/CPIForecast.xlsx?v=39439'
    logger.info("Starting Excel fetch demonstration...")
    fetch_excel_file(fetched_folder_name, "changesinprice.xlsx", excel_url)
